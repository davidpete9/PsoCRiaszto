...
# Date: Tue, 11 May 2021 09:35:04 GMT
#set_units -time ns
...
create_generated_clock -name {pwn1_clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 401 799} -nominal_period 16666.666666666664 [list [get_pins {ClockBlock/dclk_glb_2}]]
create_generated_clock -name {timer_clock} -source [get_pins {ClockBlock/clk_sync}] -edges {1 401 799} -nominal_period 16666.666666666664 [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {beeper_clk} -source [get_pins {ClockBlock/clk_sync}] -edges {1 1201 2401} [list [get_pins {ClockBlock/dclk_glb_4}]]
