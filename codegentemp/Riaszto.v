...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b950e7b5-38c6-40f3-8488-6f6c6cab6bf6"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("92a6ebc2-e914-49c3-b0b1-d6cd32b41242"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    VDAC8_v1_90_10 VDAC8_ESP (
        .data(8'b00000000),
        .strobe(1'b0),
        .vOut(Net_669));
    defparam VDAC8_ESP.Data_Source = 0;
    defparam VDAC8_ESP.Initial_Value = 206;
    defparam VDAC8_ESP.Strobe_Mode = 0;
