...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("3314fc94-9c13-4ea5-9957-cc33a48bb7cf/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module SPI_Master_v2_50_1 (
	...
	assign tmpOE__cy_bufoe_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{Net_294} : {Net_294};
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1000000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=62500, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_SAR_RADAR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_RADAR, CY_INSTANCE_SHORT_NAME=ADC_SAR_RADAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_SAR_RADAR, )
module ADC_SAR_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("89864601-f102-4a1d-acac-c654d567b08f/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=2, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=1, ControlReg=false, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=1, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=400, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=false, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=false, TermVisibility_kill=true, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=false, UseControl=true, UseInterrupt=false, UseStatus=false, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=PWM_BACKLIGHT, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM_BACKLIGHT, CY_INSTANCE_SHORT_NAME=PWM_BACKLIGHT, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=PWM_BACKLIGHT, )
module PWM_v3_30_5 (
    capture,
    clock,
    cmp_sel,
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1024000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=64000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_SAR_PR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_PR, CY_INSTANCE_SHORT_NAME=ADC_SAR_PR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=ADC_SAR_PR, )
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("83c7bb8e-ddb4-4849-8237-6a4a0b145729"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d10068f2-7146-4096-b7d2-b5e6c4b44971"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__ROW4_net;
	wire [0:0] tmpFB_0__ROW4_net;
	wire [0:0] tmpIO_0__ROW4_net;
	wire [0:0] tmpINTERRUPT_0__ROW4_net;
	electrical [0:0] tmpSIOVREF__ROW4_net;

	cy_psoc3_pins_v1_10
		#(.id("e43bbaa0-f969-4776-9997-b2963ccf17ab"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		ROW4
		 (.oe(tmpOE__ROW4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__ROW4_net[0:0]}),
		  .io({tmpIO_0__ROW4_net[0:0]}),
		  .siovref(tmpSIOVREF__ROW4_net),
		  .interrupt({tmpINTERRUPT_0__ROW4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__ROW4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("dde231e2-25bb-409f-9a45-c213f22ff834"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ee4f648f-0556-4cb8-8494-24d95e598006"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__COL4_net;
	wire [0:0] tmpFB_0__COL4_net;
	wire [0:0] tmpIO_0__COL4_net;
	wire [0:0] tmpINTERRUPT_0__COL4_net;
	electrical [0:0] tmpSIOVREF__COL4_net;

	cy_psoc3_pins_v1_10
		#(.id("a947425b-cb8f-4030-b6e6-3302319aabb8"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		COL4
		 (.oe(tmpOE__COL4_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__COL4_net[0:0]}),
		  .io({tmpIO_0__COL4_net[0:0]}),
		  .siovref(tmpSIOVREF__COL4_net),
		  .interrupt({tmpINTERRUPT_0__COL4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__COL4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__SDAT_1_net;
	wire [0:0] tmpFB_0__SDAT_1_net;
	wire [0:0] tmpINTERRUPT_0__SDAT_1_net;
	electrical [0:0] tmpSIOVREF__SDAT_1_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("1425177d-0d0e-4468-8bcc-e638e5509a9b"),
		  ...
		  .input_buffer_sel(2'b00))
		SDAT_1
		 (.oe(tmpOE__SDAT_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__SDAT_1_net[0:0]}),
		  .io({Net_19}),
		  .siovref(tmpSIOVREF__SDAT_1_net),
		  .interrupt({tmpINTERRUPT_0__SDAT_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__SDAT_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("61bbf6b3-5647-4299-a1d4-cb681dc25f35"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_2 UART (
        ...
        .rx_clk(Net_622),
        .rx_data(Net_623),
        .rx_interrupt(Net_624),
        .tx(Net_52),
        .tx_clk(Net_625),
        .tx_data(Net_626),
        .tx_en(Net_627),
        .tx_interrupt(Net_628));
	...
	cy_psoc3_pins_v1_10
		#(.id("161c319f-5379-49e5-9950-1de99fe60542"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__RADAR_net;
	wire [0:0] tmpFB_0__RADAR_net;
	wire [0:0] tmpIO_0__RADAR_net;
	wire [0:0] tmpINTERRUPT_0__RADAR_net;
	electrical [0:0] tmpSIOVREF__RADAR_net;
	...
	cy_psoc3_pins_v1_10
		...
		RADAR
		 (.oe(tmpOE__RADAR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__RADAR_net[0:0]}),
		  .analog({Net_77}),
		  .io({tmpIO_0__RADAR_net[0:0]}),
		  .siovref(tmpSIOVREF__RADAR_net),
		  .interrupt({tmpINTERRUPT_0__RADAR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__RADAR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__REED_RELAY_net;
	wire [0:0] tmpFB_0__REED_RELAY_net;
	wire [0:0] tmpIO_0__REED_RELAY_net;
	wire [0:0] tmpINTERRUPT_0__REED_RELAY_net;
	electrical [0:0] tmpSIOVREF__REED_RELAY_net;

	cy_psoc3_pins_v1_10
		#(.id("822e4b6d-ec02-4e24-aff0-2695fd960c2f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		REED_RELAY
		 (.oe(tmpOE__REED_RELAY_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__REED_RELAY_net[0:0]}),
		  .io({tmpIO_0__REED_RELAY_net[0:0]}),
		  .siovref(tmpSIOVREF__REED_RELAY_net),
		  .interrupt({tmpINTERRUPT_0__REED_RELAY_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__REED_RELAY_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__BACKLIGHT_net;
	wire [0:0] tmpFB_0__BACKLIGHT_net;
	wire [0:0] tmpIO_0__BACKLIGHT_net;
	wire [0:0] tmpINTERRUPT_0__BACKLIGHT_net;
	electrical [0:0] tmpSIOVREF__BACKLIGHT_net;

	cy_psoc3_pins_v1_10
		#(.id("c3231cbc-0f21-4ff2-883d-09660d2abe49"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BACKLIGHT
		 (.oe(tmpOE__BACKLIGHT_net),
		  .y({Net_558}),
		  .fb({tmpFB_0__BACKLIGHT_net[0:0]}),
		  .io({tmpIO_0__BACKLIGHT_net[0:0]}),
		  .siovref(tmpSIOVREF__BACKLIGHT_net),
		  .interrupt({tmpINTERRUPT_0__BACKLIGHT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BACKLIGHT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_5 PWM_BACKLIGHT (
        .capture(1'b0),
        .clock(Net_135),
        .cmp_sel(1'b0),
        .enable(1'b1),
        ...
        .tc(Net_561),
        .trigger(1'b0));
    defparam PWM_BACKLIGHT.Resolution = 16;
    ...
    PWM_v3_30_6 PWM_BEEPER (
        ...
        .tc(Net_589),
        .trigger(1'b0));
    defparam PWM_BEEPER.Resolution = 8;
	...
	wire [0:0] tmpOE__BEEPER_net;
	wire [0:0] tmpFB_0__BEEPER_net;
	wire [0:0] tmpIO_0__BEEPER_net;
	wire [0:0] tmpINTERRUPT_0__BEEPER_net;
	electrical [0:0] tmpSIOVREF__BEEPER_net;

	cy_psoc3_pins_v1_10
		#(.id("dc4be174-b6e3-48c0-970e-5c7d6acf74ea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BEEPER
		 (.oe(tmpOE__BEEPER_net),
		  .y({Net_585}),
		  .fb({tmpFB_0__BEEPER_net[0:0]}),
		  .io({tmpIO_0__BEEPER_net[0:0]}),
		  .siovref(tmpSIOVREF__BEEPER_net),
		  .interrupt({tmpINTERRUPT_0__BEEPER_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__BEEPER_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_v3_10_7 ADC_SAR_PR (
        .aclk(1'b0),
        .eoc(Net_596),
        .eos(Net_599),
        .soc(1'b0),
	...
	wire [0:0] tmpOE__PHRES_net;
	wire [0:0] tmpFB_0__PHRES_net;
	wire [0:0] tmpIO_0__PHRES_net;
	wire [0:0] tmpINTERRUPT_0__PHRES_net;
	electrical [0:0] tmpSIOVREF__PHRES_net;

	cy_psoc3_pins_v1_10
		#(.id("84c17e14-dc7e-4702-8afd-0bbd39207e86"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		PHRES
		 (.oe(tmpOE__PHRES_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PHRES_net[0:0]}),
		  .analog({Net_593}),
		  .io({tmpIO_0__PHRES_net[0:0]}),
		  .siovref(tmpSIOVREF__PHRES_net),
		  .interrupt({tmpINTERRUPT_0__PHRES_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__PHRES_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    defparam UART_GSM.NumDataBits = 8;
    defparam UART_GSM.NumStopBits = 1;
    defparam UART_GSM.ParityType = 0;
    defparam UART_GSM.RXEnable = 1;
    defparam UART_GSM.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("b0974d86-0fbe-4de9-affb-e3a00b775bbe"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__GSM_DTR_net;
	wire [0:0] tmpFB_0__GSM_DTR_net;
	wire [0:0] tmpIO_0__GSM_DTR_net;
	wire [0:0] tmpINTERRUPT_0__GSM_DTR_net;
	electrical [0:0] tmpSIOVREF__GSM_DTR_net;

	cy_psoc3_pins_v1_10
		#(.id("90504a62-f131-4f9a-ab24-aa3ff6d36ad9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		GSM_DTR
		 (.oe(tmpOE__GSM_DTR_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__GSM_DTR_net[0:0]}),
		  .io({tmpIO_0__GSM_DTR_net[0:0]}),
		  .siovref(tmpSIOVREF__GSM_DTR_net),
		  .interrupt({tmpINTERRUPT_0__GSM_DTR_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__GSM_DTR_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
